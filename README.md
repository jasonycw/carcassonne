...
Current gameplay screenshots and recordings are generated by the automated Playwright proof matrix and are maintained as PR review evidence. Stale legacy screenshot files are intentionally not tracked in the repository.
