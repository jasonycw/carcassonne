...
Current gameplay proof is generated by the automated Playwright matrix. To preserve the README’s original compact layout, the latest representative screenshot is kept in a collapsed section; the complete base, River, Tower, combined, and all-expansions screenshot/video matrix remains in [PR #2](https://github.com/jasonycw/carcassonne/pull/2).

<details>
<summary>Show latest verified gameplay screenshot</summary>

![Base game final scoreboard](https://github.com/user-attachments/assets/94b879de-1db5-4e40-81c9-c44c3836d11c)

</details>

Stale legacy screenshot files are intentionally not tracked in the repository.
