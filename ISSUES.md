...
- The README has a useless screenshots "Rotation indicator", I don't know why it needs to be here, the rotation indicator should be in part of the mid-game screenshot
...
* THIS FILE MUST NOT BE CHANGED BY LLM, ONLY ALLOWED TOBE UPDATED BY HUMAN AFTER VERIFICATION *