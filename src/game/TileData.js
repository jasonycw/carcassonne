...
export const THE_RIVER_TILES = [
  // Source tile - starting tile with river flowing out
  {
    id: 'the-river/I.s',
    northEdge: 'field',
    southEdge: 'river',
    ...
    cities: [],
    farms: [
      { directions: ['NNW', 'NNE', 'ENE', 'ESE', 'WSW', 'WNW'], meepleOffset: { x: 1/2, y: 1/4 } },
      { directions: ['SSW', 'SSE'], meepleOffset: { x: 1/2, y: 3/4 } }
    ],
  ...
  // Lake tile - ending tile with river flowing in
  {
    id: 'the-river/I.e',
    northEdge: 'river',
    southEdge: 'field',
  ...
  },
  {
    ...
    farms: [
      { directions: ['NNW', 'NNE', 'ENE', 'ESE', 'SSE', 'SSW', 'WSW', 'WNW'], meepleOffset: { x: 1/2, y: 1/2 }, adjacentCityIndices: [0, 1] }
    ],
